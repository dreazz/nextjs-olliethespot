...
function (_BaseControl) {
  ...
  function GeolocateControl(props) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(GeolocateControl).call(this, props));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_setupMapboxGeolocateControl", function (supportsGeolocation) {
      ...
      _this._mapboxGeolocateControl = new _mapboxgl.default.GeolocateControl(controlOptions); // the following re-implement MapboxGeolocateControl's _setupUI
      // replace mapbox internal prop

      _this._mapboxGeolocateControl._watchState = 'OFF'; // replace mapbox internal UI elements

      _this._mapboxGeolocateControl._geolocateButton = _this._geolocateButtonRef.current; // replace mapbox internal methods
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_onClickGeolocate", function () {
      return _this._mapboxGeolocateControl.trigger();
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_updateMarker", function (position) {
      if (position) {
        _this.setState({
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_getBounds", function (position) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_updateCamera", function (position) {
      ...
      _this.props.onViewportChange(viewState);
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_renderButton", function (type, label, callback, children) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_renderMarker", function () {
  ...
  (0, _createClass2.default)(GeolocateControl, [{
    ...
    value: function _render() {
      ...
      }, [this._renderMarker(), this._renderButton('geolocate', 'Geolocate', this._onClickGeolocate)]);
    }
  }]);
